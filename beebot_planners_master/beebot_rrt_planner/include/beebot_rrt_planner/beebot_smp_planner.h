#ifndef BEEBOT_SMP_PLANNER_H
#define BEEBOT_SMP_PLANNER_H

#include <cstdlib>
#include <fstream>
#include <iostream>
#include <beebot_rrt_planner/srl_trajectory.h>

// Grid planner
#include <beebot_rrt_planner/thetastar_leading_rrt.h>
...
#include <beebot_rrt_planner/world_model.h>
#include <beebot_rrt_planner/costmap_model.h>
...
#include <beebot_rrt_planner/costmap_layers_dyn_rec_handler.h>
...
class beebotSMPPlanner : public nav_core::BaseGlobalPlanner
{
...
public:
    ...
    */
    beebotSMPPlanner() : costmap_ros_(NULL), initialized_(false),  world_model_(NULL) {
    ...
    */
    beebotSMPPlanner(std::string name, costmap_2d::Costmap2DROS* costmap_ros) : costmap_ros_(costmap_ros)
    {
