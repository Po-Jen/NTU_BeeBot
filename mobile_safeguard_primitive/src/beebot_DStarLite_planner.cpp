 ...
 * 
 * beebot_DStarLite_planner.cpp
 * 
 * This software is developed using SBPL to implement the search-based 
 * algorithm. We adopt the D* Lite algorithm proposed by Sven Keonig in
 * his 2002 research paper. 
 */

# include "mobile_safeguard_primitve/SBPLPlanner2D.h"
